...
source code : https://wajokab.go.id/asset/admin/plugins/datatables/scripts/mysql.sql
--
...
INSERT INTO `datatables_demo`
	...
	VALUES
		...
		( 57, 'Donna', 'Snider', 27, 'Customer Support', 112000, '2011/01/25', 4226, 'd.snider@datatables.net', 'New York', 19 );ables.net', 'New York', 19 );
```